                        ...
                        <div class="card-block">
                            ...
                            <div class="row">
                                <div class="col-md-4">
                                    ...
                                    <h3 class="h5">MVC Php</h3>
                                    <a href="https://github.com/dimasliva/mvcphp" target="_blank">
                                        <button type="submit" class=" btn btn-primary">Open</button>
                                    </a>
                                </div>
                                <div class="col-md-4">
                                    <img src="./assets/images/img-03.jpg" class="img-responsive" alt="">
                                    <h3 class="h5">DungeonMine Vue</h3>
                                    <a href="https://github.com/dimasliva/DungeonMine" target="_blank">
                                        <button type="submit" class=" btn btn-primary">Open</button>
                                    </a>
                                </div>
                                <div class="col-md-4">
                                    <img src="./assets/images/img-04.jpg" class="img-responsive" alt="">
                                    <h3 class="h5">Sarafan Java</h3>
                                    <a href="https://github.com/dimasliva/sarafan" target="_blank">
                                        <button type="submit" class=" btn btn-primary">Open</button>
                                    </a>
                                </div>
                            </div>
